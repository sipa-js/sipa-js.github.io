...
If you want to find more about Yarn, you can find more information about it and how to install it, in its official [docs](https://classic.yarnpkg.com/en/docs).
