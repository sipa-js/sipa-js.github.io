...
- [Node.js](https://nodejs.org/en/download/) runtime version 18.x or above
...
```bash
sipa 0.9.53 @ 2026-04-28T08:22:09.154Z
```
...
Then you can continue with the [Sipa CLI](guides-basics/sipa-cli).